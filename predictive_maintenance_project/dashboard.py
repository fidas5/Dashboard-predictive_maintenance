...
# Sélection d'un échantillon pour simulation
...
# Prédiction pour l'échantillon sélectionné
...
with col1:
    ...
    # Extraire les valeurs des capteurs
...
with col2:
    ...
    # Graphique en camembert des probabilités
...
# Créer des données simulées pour les tendances
col1, col2 = st.columns(2)

with col1:
    # Graphique de température dans le temps
    ...
    fig_temp.add_trace(go.Scatter(
        ...
        y=temp_data,
        mode="lines+markers",
        name="Température Processus",
        line=dict(color="orange")
    ))
    fig_temp.update_layout(
        title="Évolution de la Température (30 derniers jours)",
        xaxis_title="Date",
...
with col2:
    # Graphique de vitesse de rotation dans le temps
    ...
    fig_speed.update_layout(
        title="Évolution de la Vitesse de Rotation (30 derniers jours)",
        xaxis_title="Date",
...
# Section de distribution des données
st.markdown("---")
...
with col1:
    fig_hist1 = px.histogram(df, x="Process_temperature__K", color="Target", 
                            title="Distribution de la Température du Processus",
                            labels={"Target": "Défaillance"})
    st.plotly_chart(fig_hist1, use_container_width=True)

with col2:
    fig_hist2 = px.histogram(df, x="Rotational_speed__rpm", color="Target",
                            title="Distribution de la Vitesse de Rotation",
                            labels={"Target": "Défaillance"})
